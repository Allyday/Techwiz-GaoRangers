...
class PublicController extends Controller
{
    ...
    public function search(){
        ...
        $searchTen = "";//Lấy từ search theo tên - test = rice
        $tags = [];//mảng id của table food_tags - test = 15
        $cate = 0; //id của table dish_category test = 5
        $price = "";//giá tiền;
        $xeptheosao = 0;// = 0 thi sap xep theo gan xa, = 1 thi sap xep theo stars
